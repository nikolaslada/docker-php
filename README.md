# Docker image for PHP repository

## This repo is fork of official Docker image for PHP

## About this (original) Repo
...
-	[Automated build:  
	![build status badge](https://doi-janky.infosiftr.net/job/update.sh/job/php/badge/icon)](https://hub.docker.com/r/nikolaslada/php/builds/)
